...
async def tg_folders(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if folders:
            ...
            msg += "\n\n✅ ফোল্ডার কী কপি করে /confirm দিন"
        else:
